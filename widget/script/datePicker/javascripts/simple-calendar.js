...
var LunarHelp = function () {
  function LunarHelp(year, month, day) {
    ...
    //计算年数
    for (i = 1900; i < 2101 && offset - this.lYearDays(i) > 0; i++) {
...
var SimpleCalendar = function () {
  ...
  _createClass(SimpleCalendar, [{
    ...
    value: function create() {
      ...
      //actions
      header.innerHTML = header.innerHTML + '<div class="sc-actions" ><div class="sc-yleft">&lsaquo;</div><span ><select class="sc-select-year" name="" style="margin-bottom:-0.4rem;text-align: center;"></select></span><div class="sc-yright">&rsaquo;</div></div>';
      header.innerHTML = header.innerHTML + '<div class="sc-actions"><div class="sc-mleft">&lsaquo;</div><span ><select class="sc-select-month" name="" style="margin-bottom: -0.4rem;text-align: center;"></select></span><div class="sc-mright">&rsaquo;</div></div>';
      ...
      for (var i = 0; i < 7; i++) {
        week.innerHTML = week.innerHTML + ' <div class="sc-week-item" style=""></div>';
      }
      for (var i = 0; i < 42; i++) {
...
//    self.setInterval('SimpleCalendar.timeupdate()', 200);
    ...
    value: function updateEvent() {
      ...
      daysElement.forEach(function (v, i) {
        ...
        v.onclick = function () {
          var cClickVlaue=v.querySelector(".day").innerHTML;
          calendar.selectDay = v;
	        ...
	        }else if(cClickVlaue<14 && i>28){
	        
	        }else{
	          var selectDate=container.querySelector('.sc-selected .day');
	          cClickDate=selectDate.innerHTML;
      ...
      yearadd.onclick = function () {
        ...
        cClickYear=currentyear;
        if(this.tmonth){
        cClickMonth=this.tmonth;
        }
        getMonthAttendance(1);
      };
