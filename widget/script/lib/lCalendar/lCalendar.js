		...
		bindEvent: function(type) {
			...
			function popupDate(e) {
				...
				_self.gearDate.innerHTML = '<div class="date_ctrl slideInUp">' +
					...
					'<div class="date_btn lcalendar_finish">OK</div>' +
					'</div>' +
				...
				var gearDate = _self.gearDate;
				gearDate.addEventListener('touchstart', function(e){
					closeMobileCalendar(e);
				});
				
				var date_ctrl = _self.gearDate.querySelector(".date_ctrl");
				date_ctrl.addEventListener('touchstart', function(e){
					e.stopPropagation();
				});
			...
			function popupDate1(e) {
				...
				lcalendar_cancel.addEventListener('touchstart', closeMobileCalendar);
				var lcalendar_finish = _self.gearDate.querySelector(".lcalendar_finish");
				lcalendar_finish.addEventListener('touchstart', finishMobileDate1);
